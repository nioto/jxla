...
public class Constants {
  ...
  public static final String  MAXVALUES_COUNTRIES = "countries";
  public static final String  MAXVALUES_BROWSERS  = "browsers";
  public static final String  MAXVALUES_OSES      = "operating-system";
